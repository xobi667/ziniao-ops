...
Write-Host "2. Ask Codex: 打开 <店铺关键词> 全部数据 / 订单数据 / 广告数据"
Write-Host "3. If a login page appears, complete login locally and run the same sentence again. ziniao-ops does not handle passwords or verification codes."
