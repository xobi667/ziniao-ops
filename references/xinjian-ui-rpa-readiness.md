...
- Row-context execution: 12 row-level actions can be planned with explicit RowIndex/RowText; none are blindly clicked by default.
...
- row_context_required: 12. Row-level actions need RowIndex or RowText; the invoker refuses to blindly click a row.
