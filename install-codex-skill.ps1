...
Write-Host "Restart Codex and ask: 打开 <店铺关键词> 的全部数据 / 订单数据 / 广告数据"
Write-Host "Codex should use open-store.ps1. It first reuses the current Ziniao/store window, then falls back to login handoff, shop scan, and automatic continue."
